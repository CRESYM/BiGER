...
model GridFollowingControl
  ...
  Modelica.Blocks.Interfaces.RealInput PGenRefPu(start = PGen0Pu) annotation(
    Placement(transformation(origin = {-130, 56}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-110, 0}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Interfaces.RealInput UConvRefPu(start = UConv0Pu) annotation(
    Placement(transformation(origin = {-134, -13}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-110, -70}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Interfaces.RealInput udPccPu(start = udPcc0Pu) annotation(
    Placement(transformation(origin = {-130, -60}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-70, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Interfaces.RealInput UConvPu(start = UConv0Pu) annotation(
    Placement(transformation(origin = {-131, -40}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-20, 110}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Blocks.Interfaces.RealInput uqPccPu(start = uqPcc0Pu) annotation(
    Placement(transformation(origin = {-130, -80}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-30, -110}, extent = {{10, -10}, {-10, 10}}, rotation = 270)));
  Modelica.Blocks.Interfaces.RealInput idConvPu(start = idConv0Pu) annotation(
    Placement(transformation(origin = {-130, -100}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {30, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Interfaces.RealInput iqConvPu(start = iqConv0Pu) annotation(
    Placement(transformation(origin = {-130, -120}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {69, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  ...
  BaseControls.ReactivePowerLoop reactivePowerLoop(Kiv = Kiv, Kpv = Kpv, Tlpf = Tlpf, UConv0Pu = UConv0Pu, UConvRef0Pu = UConv0Pu, InomPu = InomPu, idConv0Pu = idConv0Pu, iqConv0Pu = iqConv0Pu) annotation(
    Placement(transformation(origin = {-60.5, -26.5}, extent = {{-26.5, -26.5}, {26.5, 26.5}})));
  Modelica.Blocks.Interfaces.BooleanInput freeze annotation(
    Placement(transformation(origin = {-134.5, 9.5}, extent = {{-14.5, -14.5}, {14.5, 14.5}}), iconTransformation(origin = {1.77636e-15, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
equation
  ...
  connect(udPccPu, currentLoopGFL.udPccPu) annotation(
    Line(points = {{-130, -60}, {41, -60}, {41, -15}}, color = {0, 0, 127}));
  connect(uqPccPu, currentLoopGFL.uqPccPu) annotation(
    Line(points = {{-130, -80}, {31, -80}, {31, -15}, {30, -15}}, color = {0, 0, 127}));
  connect(idConvPu, currentLoopGFL.idConvPu) annotation(
    Line(points = {{-130, -100}, {68, -100}, {68, -15}}, color = {0, 0, 127}));
  connect(iqConvPu, currentLoopGFL.iqConvPu) annotation(
    Line(points = {{-130, -120}, {57, -120}, {57, -15}}, color = {0, 0, 127}));
  ...
  connect(PGenRefPu, activePowerLoop.PGenRefPu) annotation(
    Line(points = {{-130, 56}, {-90, 56}}, color = {0, 0, 127}));
  ...
  connect(iqConvPu, activePowerLoop.iqConvPu) annotation(
    Line(points = {{-130, -120}, {-100, -120}, {-100, 80}, {-60.25, 80}, {-60.25, 71}, {-60.375, 71}, {-60.375, 72}, {-60.5, 72}}, color = {0, 0, 127}));
  connect(UConvPu, reactivePowerLoop.UConvPu) annotation(
    Line(points = {{-131, -40}, {-90, -40}}, color = {0, 0, 127}));
  connect(UConvRefPu, reactivePowerLoop.UConvRefPu) annotation(
    Line(points = {{-134, -13}, {-90, -13}}, color = {0, 0, 127}));
  connect(reactivePowerLoop.iqRefPu, currentLoopGFL.iqConvRefPu) annotation(
    Line(points = {{-31, -26.5}, {1, -26.5}, {1, -12}, {19, -12}}, color = {0, 0, 127}));
  connect(idConvPu, reactivePowerLoop.idConvPu) annotation(
    Line(points = {{-130, -100}, {-108, -100}, {-108, 11}, {-60.25, 11}, {-60.25, 2}, {-61.375, 2}, {-61.375, 3}, {-60.5, 3}}, color = {0, 0, 127}));
  connect(freeze, activePowerLoop.freeze) annotation(
    Line(points = {{-134, 10}, {-113, 10}, {-113, 42}, {-90, 42}}, color = {255, 0, 255}));
  connect(freeze, reactivePowerLoop.freeze) annotation(
    Line(points = {{-134, 10}, {-113, 10}, {-113, -26}, {-90, -26}}, color = {255, 0, 255}));
  annotation(
