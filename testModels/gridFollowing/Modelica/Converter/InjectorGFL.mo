...
/* DQ voltages and currents at PCC */
  udPccPu = cos(thetaPLLPu)*terminal.V.re + sin(thetaPLLPu)*terminal.V.im;
  uqPccPu = -sin(thetaPLLPu)*terminal.V.re + cos(thetaPLLPu)*terminal.V.im;
...
//  uConvPu.re= cos(thetaPLLPu) * udConvRefPu + sin(thetaPLLPu) * uqConvRefPu;
//  uConvPu.im= -sin(thetaPLLPu) * udConvRefPu + cos(thetaPLLPu) * uqConvRefPu;
