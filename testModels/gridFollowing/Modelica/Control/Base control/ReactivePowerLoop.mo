...
//Initial values
  ...
  Dynawo.NonElectrical.Blocks.Continuous.IntegratorVariableLimits integratorVariableLimits(K = Kiv)  annotation(
    Placement(visible = true, transformation(origin = {-3, -34}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder(T = Tlpf)  annotation(
    Placement(visible = true, transformation(origin = {-110, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder1(T = Tlpf)  annotation(
...
equation
  ...
  connect(switch1.y, integratorVariableLimits.u) annotation(
    Line(points = {{-23, 0}, {-20, 0}, {-20, -34}, {-15, -34}}, color = {0, 0, 127}));
  ...
  connect(iq1maxPu.y, integratorVariableLimits.limitMax) annotation(
    Line(points = {{-151, -100}, {-50, -100}, {-50, -26}, {-15, -26}}, color = {0, 0, 127}));
  ...
  connect(gain1.y, integratorVariableLimits.limitMin) annotation(
    Line(points = {{-23, -100}, {-20, -100}, {-20, -42}, {-15, -42}}, color = {0, 0, 127}));
  ...
  connect(integratorVariableLimits.y, add.u2) annotation(
    Line(points = {{8, -34}, {22, -34}, {22, -7}, {31, -7}}, color = {0, 0, 127}));
