...
import Dynawo;
  ...
  parameter Types.PerUnit Kpp= 33.3 "Proportional gain of the active power loop";
  ...
  parameter Types.Time Tpll= 0.10 "Time constant of PLL to calculate KpPLL and kiPLL (Tau)";
  ...
  /* Converter */
  parameter Types.ComplexCurrentPu iPcc0Pu=ComplexMath.conj(Complex(PGen0Pu, QGen0Pu)/uPcc0Pu);
  ...
  parameter Types.Angle thetaPLL0Pu= ComplexMath.arg(uPcc0Pu);
  ...
  parameter Types.Angle UPhaseBus0= 0 "Infinite bus constant voltage angle in rad";
  parameter Types.ComplexCurrentPu iTerminal0Pu = ComplexMath.conj(Complex(PInf0Pu, QInf0Pu)/uInf0Pu) "Initial complex current at terminal in pu (base UNom, SNom)";
  parameter Types.ComplexVoltagePu uTerminal0Pu = Complex(RInfPu, XInfPu) * iTerminal0Pu + uInf0Pu "Initial complex voltage at terminal in pu (base UNom)";
  parameter Types.PerUnit UTerminal0Pu = ComplexMath.'abs'(uTerminal0Pu);
