...
model SingleVSC_v5
  import Dynawo;
  import Modelica;
  Dynawo.Examples.GridFollowing_v5.InitSingleVSC_v5 SingleVSC_INIT;
  ...
  omegaRef0= SingleVSC_INIT.omegaNom,
  ...
  Modelica.Blocks.Sources.Constant omegaRef(k = SingleVSC_INIT.omegaNom) annotation(
...
equation
  ...
  connect(omegaRef.y, GridFollowingControl.omegaRef) annotation(
